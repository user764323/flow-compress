        ...
        df_data.append(
            {
                ...
                "Teacher": r.get("teacher_model", "unknown"),
                "Student": r.get("student_model", "unknown"),
...
def plot_compression_vs_accuracy(results: List[Dict[str, Any]], output_dir: Path):
    ...
    ax.scatter(compressions, metrics, s=100, alpha=0.6, label="FAD")
...
def main():
    parser = argparse.ArgumentParser(description="Visualize distillation results")
    parser.add_argument("--results-dir", type=str, default="./experiments/results")
    parser.add_argument("--output", type=str, default="./experiments/results/distillation_viz")
